      ...
      <Suspense fallback={<Spinner />}>
        <Switch>
          <Route
            ...
            path="/"
            render={(props) => (
              <HomeLazy {...props} currentUser={currentUser} />
            )}
          />
          <Route
            path="/login"
            render={(props) => (
              <LoginLazy {...props} currentUser={currentUser} />
            )}
          />
          <Route
            path="/register"
            render={(props) => (
              <RegisterLazy {...props} currentUser={currentUser} />
            )}
          />
          ...
          <SecureRoute
            ...
            component={(props) => (
              <UserDashboardLazy {...props} currentUser={currentUser} />
            )}
          />
          <SecureRoute
